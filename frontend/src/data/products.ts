...
export const categoryMeta = {
  "dog-bed": { name: "宠物狗窝", description: "舒适透气，四季可用的狗窝系列。" },
  bowl: { name: "宠物饭碗", description: "防滑耐用，适配不同体型犬只。" },
  "dog-food": { name: "宠物狗粮", description: "营养均衡，针对不同年龄段犬只。" },
  treat: { name: "宠物零食", description: "健康配方，训练奖励更省心。" }
};
